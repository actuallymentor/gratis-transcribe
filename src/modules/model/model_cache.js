 ...
 */
export const get_selected_model_profile_id = async () => get_setting( SETTING_KEYS.selected_model_profile, DEFAULT_MODEL_PROFILE_ID )
...
export const clear_model_caches = async () => {
    ...
    const model_caches = cache_names.filter( cache_name => cache_name.includes( `transformers` ) || cache_name.includes( `model` ) || cache_name.includes( `onnx` ) )
